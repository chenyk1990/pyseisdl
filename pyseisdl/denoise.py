...
def ksvd_denoise(din,mode,l,s,perc,param):
	"""
	ksvd_denoise: KSVD algorithm for 2D and 3D denoising
	BY Yangkang Chen
	Jan, 2020
	Modified on Mar, 2020
...
def fast_ksvd_denoise(din,mode,l,s,perc,param):
    """
    fast_ksvd_denoise: fast KSVD algorithm for 2D and 3D denoising 
    Modified by Lucas Aires
    Jan, 2026
